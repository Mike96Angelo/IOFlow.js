...
function createIOFlow(ioFunc, options) {
    ...
    ioFlow.addSubscriber = function (subscriber) {
        subscribers.add(subscriber);
    };
    ioFlow.removeSubscriber = function (subscriber) {
        subscribers.delete(subscriber);
    };
    ioFlow.subscribeTo = function () {
        var subscriptions = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            subscriptions[_i] = arguments[_i];
        }
        subscriptions.forEach(function (subscription) { return subscription.addSubscriber(ioFlow); });
    };
    ioFlow.unsubscribeFrom = function () {
        var subscriptions = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            subscriptions[_i] = arguments[_i];
        }
        subscriptions.forEach(function (subscription) { return subscription.removeSubscriber(ioFlow); });
    };
    return ioFlow;
}
exports.default = createIOFlow;
//# sourceMappingURL=ioflow.js.map